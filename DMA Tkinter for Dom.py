...
def set_voltage(voltage, name):
    signal_factor = 1/2000
    voltage_output = voltage * signal_factor
    #Labjack code here to set voltage
    
def read_voltage(instrument, name = '0', scaling = 1):
     result = d.getAIN(name)
...
def run_program():
    ...
    with open(filename, 'w', newline='') as csvfile:
        ...
        while (current_voltage <= voltage_end):
            ...
            read_voltage(dma_voltage, dma_read, 200)
            read_voltage(electrometer_voltage, electrometer_read)
            ...
            #Set voltage
            DAC0_VALUE = d.voltageToDACBits(current_voltage/200, dacNumber = 0, is16Bits = False)
